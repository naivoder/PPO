...
class PPOAgent:
    def __init__(
        ...
        self.actor = Actor(
            n_actions, input_dims, alpha, chkpt_dir=f"weights/{env_name}_actor.pt"
        )
        self.critic = Critic(
    ...
    def learn(self):
        ...
        for _ in range(self.n_epochs):
            ...
            for batch in batches:
                ...
                # another one of those Phil Tabor choices I'm not sure I understand...
                # Ive got vague plans to come back and experiment with this value
